...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->tinyInteger('is_locked', false, true)->unsigned()->default(0)->comment('是否锁定');
            $table->tinyInteger('type', false, true)->unsigned()->default(1)->comment('账号注册类型 1：账号 2：邮箱 3：手机');
            $table->rememberToken();
